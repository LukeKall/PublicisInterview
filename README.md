...
L’éditeur vous demande de développer une application mobile Android, en utilisant __Jetpack Compose__, comprenant deux interfaces :
...
__NOTE IMPORTANTE : L'exercice doit être effectué grâce à Jetpack Compose__
