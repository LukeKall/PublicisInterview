...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            MyApplicationTheme {
                MainScreen(books = createBooks() , modifier = Modifier.fillMaxSize())
            }
        }
    }
}

private fun createBooks() = listOf(
    Book(
        isbn = Book.ISBN("c8fabf68-8374-48fe-a7ea-a00ccd07afff"),
        title = "Henri Potier à l'école des sorciers",
        price = 35,
        coverUrl = "https://firebasestorage.googleapis.com/v0/b/henri-potier.appspot.com/o/hp0.jpg?alt=media",
        synopsis = listOf(
    ...
    Book(
        ...
        price = 30,
        coverUrl = "https://firebasestorage.googleapis.com/v0/b/henri-potier.appspot.com/o/hp1.jpg?alt=media",
        synopsis = listOf(
    ...
    Book(
        ...
        price = 30,
        coverUrl = "https://firebasestorage.googleapis.com/v0/b/henri-potier.appspot.com/o/hp2.jpg?alt=media",
        synopsis = listOf(
    ...
    Book(
        isbn = Book.ISBN("c30968db-cb1d-442e-ad0f-80e37c077f89"),
        title = "Henri Potier et la Coupe de feu",
        price = 29,
        coverUrl = "https://firebasestorage.googleapis.com/v0/b/henri-potier.appspot.com/o/hp3.jpg?alt=media",
        synopsis = listOf(
    ...
    Book(
        isbn = Book.ISBN("78ee5f25-b84f-45f7-bf33-6c7b30f1b502"),
        title = "Henri Potier et l'Ordre du phénix",
        price = 28,
        coverUrl = "https://firebasestorage.googleapis.com/v0/b/henri-potier.appspot.com/o/hp4.jpg?alt=media",
        synopsis = listOf(
    ...
    Book(
        isbn = Book.ISBN("cef179f2-7cbc-41d6-94ca-ecd23d9f7fd6"),
        title = "Henri Potier et le Prince de sang-mêlé",
        price = 30,
        coverUrl = "https://firebasestorage.googleapis.com/v0/b/henri-potier.appspot.com/o/hp5.jpg?alt=media",
        synopsis = listOf(
    ...
    Book(
        isbn = Book.ISBN("bbcee412-be64-4a0c-bf1e-315977acd924"),
        title = "Henri Potier et les Reliques de la Mort",
        price = 35,
        coverUrl = "https://firebasestorage.googleapis.com/v0/b/henri-potier.appspot.com/o/hp6.jpg?alt=media",
        synopsis = listOf(
